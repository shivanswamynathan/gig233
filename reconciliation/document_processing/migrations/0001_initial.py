    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoice_extracted', models.BooleanField(default=False, verbose_name='Invoice Extracted')),
                ('error_details', models.TextField(blank=True, null=True, verbose_name='Error Details')),
                ('data_uploaded', models.BooleanField(default=False, verbose_name='Data Uploaded')),
                ('uploaded_by', models.CharField(blank=True, max_length=100, null=True, verbose_name='Uploaded By')),
                ('extracted_invoice_count', models.IntegerField(default=0, help_text='Number of invoices extracted for this upload', verbose_name='Extracted Invoice Count')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('po_number', models.CharField(db_index=True, max_length=200, verbose_name='PO Number')),
                ('grn_number', models.CharField(db_index=True, max_length=200, verbose_name='GRN Number')),
                ('invoice_number', models.CharField(db_index=True, max_length=100, verbose_name='Invoice Number')),
                ('vendor_name', models.CharField(db_index=True, max_length=255, verbose_name='Vendor Name')),
                ('invoice_data_id', models.IntegerField(db_index=True, verbose_name='Invoice Data ID')),
                ...
                ('action', models.BooleanField(default=False, help_text='True when user approves, False otherwise', verbose_name='Action')),
                ('approved_by', models.CharField(blank=True, max_length=100, null=True, verbose_name='Approved By')),
                ('total_amount', models.DecimalField(blank=True, decimal_places=2, help_text='Total invoice amount for reference', max_digits=15, null=True, verbose_name='Total Amount')),
                ('url', models.URLField(blank=True, help_text='URL to the invoice attachment', max_length=1000, null=True, verbose_name='Invoice URL')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
            ...
            options={
                ...
                'db_table': 'check',
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['po_number'], name='check_po_numb_e6c9f0_idx'), models.Index(fields=['grn_number'], name='check_grn_num_d4201b_idx'), models.Index(fields=['invoice_number'], name='check_invoice_e9c50a_idx'), models.Index(fields=['vendor_name'], name='check_vendor__9bf61c_idx'), models.Index(fields=['invoice_data_id'], name='check_invoice_23c4dd_idx'), models.Index(fields=['status'], name='check_status_664fc4_idx'), models.Index(fields=['action'], name='check_action_1178ca_idx')],
                'unique_together': {('po_number', 'grn_number', 'invoice_number', 'invoice_data_id')},
            },
        ),
        migrations.CreateModel(
            name='GrnSummary',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manually_enter', models.CharField(blank=True, help_text='Key entered manually from frontend', max_length=100, null=True, verbose_name='Manually enter')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.BooleanField(default=False, help_text='User approval status - True when user approves', verbose_name='Status')),
