...
class GrnSummary(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=['upload_batch_id']),
            models.Index(fields=['grn_number', 'po_number', 'seller_invoice_number']),
        ]
...
# Add this to reconciliation/document_processing/models.py
...
class InvoiceItemReconciliation(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        self.is_exception = (
            ...
            (self.total_amount_variance_percentage and abs(self.total_amount_variance_percentage) > 15)
        )
