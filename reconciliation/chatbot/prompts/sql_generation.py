...
3. Add LIMIT 100 if no LIMIT specified
...
A: SELECT * FROM invoice_item_reconciliation WHERE description_match_score < 1.0 LIMIT 100;

Q: "List variances above 500"
A: SELECT * FROM invoice_item_reconciliation WHERE ABS(total_amount_variance) > 500 LIMIT 100;

Q: "Why is PO-CFI25-06432 showing partial match?"
A: SELECT * FROM invoice_grn_reconciliation WHERE po_number ILIKE '%CFI25-06432%' LIMIT 100;
